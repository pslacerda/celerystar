...
from celerystar_apistar import codecs, conneg, exceptions
from celerystar_apistar.client.utils import (
    BlockAllCookies,
    File,
    ForceMultiPartDict,
    guess_filename,
...
class HTTPTransport(BaseTransport):
    ...
    def __init__(self, auth=None, decoders=None, headers=None, session=None):
        from celerystar_apistar import __version__
        ...
        self.decoders = (
            list(decoders) if decoders else list(self.default_decoders)
        )
        self.headers = {
