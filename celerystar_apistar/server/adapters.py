...
from celerystar_apistar.server.wsgi import RESPONSE_STATUS_TEXT
...
class ASGItoWSGIAdapter(object):
    ...
    def environ_to_message(self, environ):
        ...
        message = {
            ...
            "http_version": environ.get("SERVER_PROTOCOL", "http/1.0").split(
                "/", 1
            )[-1],
        ...
        if environ.get("CONTENT_TYPE"):
            headers.append(
                [b"content-type", environ["CONTENT_TYPE"].encode("latin-1")]
            )
